...
- On ENDEX: deliver 6-8 sentence AAR covering strengths, gaps, doctrine, recommendations.
...
export default function App() {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr 180px', gap: 8, height: '90vh', fontFamily: 'JetBrains Mono, monospace', fontSize: 12 }}>

      {/* Dispatch */}
      <div style={{ display: 'flex', flexDirection: 'column', border: '0.5px solid #222', borderRadius: 8, overflow: 'hidden' }}>
